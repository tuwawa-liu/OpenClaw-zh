...
export const zh_CN: TranslationMap = {
  ...
  chatExtra2: {
    showingLast: "显示最后 {limit} 条消息（{hidden} 条已隐藏）。",
    compaction: "压缩",
  },
  agentsExtra: {
    default: "默认",
  ...
  usageDetailsExtra: {
    ...
    msgs: "消息",
    ofInput: "占输入",
    systemTitle: "系统：~{tokens}",
    skillsTitle: "技能：~{tokens}",
    toolsTitle: "工具：~{tokens}",
    filesTitle: "文件：~{tokens}",
    you: "你",
    assistant: "助手",
    tool: "工具",
    total: "总计",
  ...
  controllersExtra: {
    deleteSessionConfirm: "删除会话 \"{key}\"？\n\n将删除会话记录并归档其对话内容。",
    rejectDeviceConfirm: "拒绝此设备配对请求？",
    newDeviceToken: "新设备令牌（请复制并安全保存）：",
    revokeTokenConfirm: "撤销 {deviceId}（{role}）的令牌？",
    skillEnabled: "技能已启用",
    skillDisabled: "技能已禁用",
    installed: "已安装",
