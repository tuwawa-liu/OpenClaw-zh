...
function renderGenericChannelCard(
  ...
  return html`
    <div class="card">
      ...
      <div class="card-sub">${t("channels.statusTitle")}</div>
      ${accountCountLabel}
          ...
          : html`
            <div class="status-list" style="margin-top: 16px;">
              <div>
                ...
                <span>${configured == null ? t("channels.na") : configured ? t("channels.yes") : t("channels.no")}</span>
              </div>
              <div>
                <span class="label">${t("channels.running")}</span>
                <span>${running == null ? t("channels.na") : running ? t("channels.yes") : t("channels.no")}</span>
              </div>
              <div>
                <span class="label">${t("channels.connected")}</span>
                <span>${connected == null ? t("channels.na") : connected ? t("channels.yes") : t("channels.no")}</span>
              </div>
            </div>
          `
      }
