...
export function renderNode(params: {
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">${t("configForm.unsupportedSchema")}: ${type}</div>
    </div>
  `;
}
  ...
  return html`
    <div class="cfg-array">
      ...
      ${
        arr.length === 0
          ? html`
              <div class="cfg-array__empty">${t("configForm.noSettingsMatch")}</div>
            `
          : html`
    ...
    <div class="cfg-map">
      ...
      ${
        visibleEntries.length === 0
          ? html`
              <div class="cfg-map__empty">${t("configForm.noSettingsMatch")}</div>
            `
          : html`
