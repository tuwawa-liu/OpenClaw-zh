      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            ...
            title=${t("overview.docs.devicePairingTitle")}
    ...
    if (isAuthRequired) {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">openclaw dashboard --no-open</span> → ${t("overview.authHints.tokenizedUrl")}<br />
            <span class="mono">openclaw doctor --generate-gateway-token</span> → ${t("overview.authHints.setToken")}
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
