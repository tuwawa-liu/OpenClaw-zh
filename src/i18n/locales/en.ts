...
export const en: TranslationMap = {
  ...
  cli: {
    ...
    models: {
      ...
      auth: {
        ...
        agentOpt: "Agent id for auth order get/set/clear",
        add: {
        ...
        order: {
          ...
          set: {
            ...
            optProvider: "Provider id (e.g. anthropic)",
            optAgent: "Agent id (default: configured default agent)",
            profileIdsArg: "Auth profile ids (e.g. anthropic:default)",
          },
          clear: {
  ...
  browserState: {
    viewportSet: "viewport set: {width}x{height}",
    offline: "offline: {offline}",
    headersSet: "headers set",
    credentialsCleared: "credentials cleared",
    credentialsSet: "credentials set",
    geolocationCleared: "geolocation cleared",
    geolocationSet: "geolocation set",
    mediaColorScheme: "media colorScheme: {colorScheme}",
  ...
  browserCookies: {
    ...
    storageSet: "{kind}Storage set: {key}",
    storageCleared: "{kind}Storage cleared",
  },
  browserElement: {
    clickedRef: "clicked ref {ref}{suffix}",
    typedIntoRef: "typed into ref {ref}",
    pressed: "pressed {key}",
    hoveredRef: "hovered ref {ref}",
    scrolledIntoView: "scrolled into view: {ref}",
    dragged: "dragged {startRef} → {endRef}",
  ...
  secretsCli: {
    ...
    reloadDescription: "Re-resolve secret references and atomically swap runtime snapshot",
    jsonOpt: "Output JSON",
    auditDescription: "Audit plaintext secrets, unresolved refs, and precedence drift",
    auditCheckOpt: "Exit non-zero when findings are present",
    configureDescription:
      "Interactive secrets helper (provider setup + SecretRef mapping + preflight)",
    configureApplyOpt: "Apply changes immediately after preflight",
    configureYesOpt: "Skip apply confirmation prompt",
    configureProvidersOnlyOpt: "Configure secrets.providers only, skip credential mapping",
    configureSkipProviderSetupOpt:
      "Skip provider setup and only map credential fields to existing providers",
    configureAgentOpt: "Agent id for auth-profiles targets (default: configured default agent)",
    configurePlanOutOpt: "Write generated plan JSON to a file",
    applyDescription: "Apply a previously generated secrets plan",
    applyFromOpt: "Path to plan JSON",
    applyDryRunOpt: "Validate/preflight only",
  },
  helpDocs: "Docs:",
  chatCmd: {
  ...
  commands: {
    ...
    configureGatewayAuth: {
      ...
      anthropicOAuthModels: "Anthropic OAuth models",
    },
...
Object.assign(en, {
  ...
  tuiLocalShell: {
    ...
    no: "No",
    yes: "Yes",
    enabled: "local shell: enabled for this session",
    notEnabled: "local shell: not enabled",
    cancelled: "local shell: cancelled",
    notEnabledSession: "local shell: not enabled for this session",
    runCmd: "[local] $ {cmd}",
  },

  onboardSearch: {
    braveHint: "Structured results · country/language/time filters",
    geminiHint: "Google Search grounding · AI-synthesized",
    grokHint: "xAI web-grounded responses",
    kimiHint: "Moonshot web search",
    perplexityHint: "Structured results · domain/country/language/time filters",
    webSearchIntro: "Web search lets your agent look things up online.",
    chooseProvider: "Choose a provider and paste your API key.",
    docsLink: "Docs: https://docs.openclaw.ai/tools/web",
    ...
    noApiKey: "No API key stored — web_search won't work until a key is available.",
  ...
  acpCli: {
    ...
    optTokenFile: "Read gateway token from file",
    optPassword: "Gateway password (if required)",
    optPasswordFile: "Read gateway password from file",
    optSession: "Default session key (e.g. agent:main:main)",
    optSessionLabel: "Default session label to resolve",
    ...
    clientOptServer: "ACP server command (default: openclaw)",
    clientOptServerArgs: "Extra arguments for the ACP server",
    clientOptServerVerbose: "Enable verbose logging on the ACP server",
    clientOptVerbose: "Verbose client logging",
  },

  directoryCli: {
    description: "Lookup contact and group IDs (self, peers, groups) for supported chat channels",
    examplesHeading: "Examples:",
    exSelf: "Show the connected account identity.",
    exPeers: "Search contact/user IDs by name.",
    exGroups: "List available groups/channels.",
    exMembers: "List members for a specific group.",
    docsLabel: "Docs:",
    optChannel: "Channel (auto when only one is configured)",
    optAccount: "Account id (accountId)",
    optJson: "Output JSON",
    unsupportedChannel: "Unsupported channel: {channelId}",
    channelNoSupport: "Channel {channelId} does not support directory {unsupported}",
    selfDesc: "Show the current account user",
    notAvailable: "Not available.",
    peersDesc: "Peer directory (contacts/users)",
    listPeersDesc: "List peers",
    optQuery: "Optional search query",
    optLimit: "Limit results",
    groupsDesc: "Group directory",
  ...
  completionCli: {
    ...
    optShell: "Shell to generate completion for (default: zsh)",
    optInstall: "Install completion script to shell profile",
    optWriteState: "Write completion scripts to $OPENCLAW_STATE_DIR/completions (no stdout)",
    ...
    actionInProgress: "{action} completion in {profilePath}...",
    installed: "Completion installed. Restart your shell or run: source {profilePath}",
    installFailed: "Failed to install completion: {err}",
  },

  memoryCli: {
    searchDisabled: "Memory search disabled.",
    noManualReindex: "Memory backend does not support manual reindex.",
    description: "Search, inspect, and reindex memory files",
    examplesHeading: "Examples:",
    exStatus: "Show index and provider status.",
    exDeep: "Probe embedding provider readiness.",
    exForce: "Force a full reindex.",
    exSearch: "Quick search using positional query.",
    exSearchLimit: "Limit results for focused troubleshooting.",
    exJson: "Output machine-readable JSON (good for scripts).",
    docsLabel: "Docs:",
    statusDesc: "Show memory search index status",
    optAgent: "Agent id (default: default agent)",
    optJson: "Print JSON",
    optDeep: "Probe embedding provider availability",
    optIndex: "Reindex if dirty (implies --deep)",
    optVerbose: "Verbose logging",
    indexDesc: "Reindex memory files",
    optForce: "Force full reindex",
    checkingMemory: "Checking memory…",
    probingVector: "Probing vector…",
    probingEmbeddings: "Probing embeddings…",
    indexingMemory: "Indexing memory…",
    indexFailed: "Memory index failed: {error}",
    indexComplete: "Memory index complete.",
    indexUpdated: "Memory index updated ({agentId}).",
    indexFailedAgent: "Memory index failed ({agentId}): {message}",
    searchDesc: "Search memory files",
    searchQueryArg: "Search query",
    optSearchQuery: "Search query (alternative to positional argument)",
    optMaxResults: "Max results",
    optMinScore: "Minimum score",
  ...
  browserCli: {
    ...
    profileOpt: "Browser profile name (default from config)",
    jsonOpt: "Output machine-readable JSON",
    targetIdOpt: "CDP target id (or unique prefix)",
  },

  // src/cli/browser-cli-extension.ts
  browserExtCli: {
    description: "Chrome extension helpers",
    installDescription: "Install the Chrome extension to a stable local path",
    pathDescription: "Print the path to the installed Chrome extension (load unpacked)",
  },

  // src/cli/browser-cli-actions-observe.ts
  browserObserveCli: {
    consoleDescription: "Get recent console messages",
    levelOpt: "Filter by level (error, warn, info)",
    pdfDescription: "Save page as PDF",
    responsebodyDescription: "Wait for a network response and return its body",
    urlArg: "URL (exact, substring, or glob like **/api)",
    timeoutMsOpt: "How long to wait for the response (default: 20000)",
    maxCharsOpt: "Max body chars to return (default: 200000)",
  },

  // src/cli/browser-cli-manage.ts
  browserManageCli: {
    statusDescription: "Show browser status",
    startDescription: "Start the browser (no-op if already running)",
    stopDescription: "Stop the browser (best-effort)",
    resetProfileDescription: "Reset browser profile (moves it to Trash)",
    tabsDescription: "List open tabs",
    tabDescription: "Tab shortcuts (index-based)",
    newTabDescription: "Open a new tab (about:blank)",
    selectTabDescription: "Focus tab by index (1-based)",
    tabIndexArg: "Tab index (1-based)",
    closeTabDescription: "Close tab by index (1-based); default: first tab",
    openDescription: "Open a URL in a new tab",
    urlArg: "URL to open",
    focusDescription: "Focus a tab by target id (or unique prefix)",
    targetIdArg: "Target id or unique prefix",
    closeDescription: "Close a tab (target id optional)",
    targetIdOptArg: "Target id or unique prefix (optional)",
    profilesDescription: "List all browser profiles",
    createProfileDescription: "Create a new browser profile",
    profileNameOpt: "Profile name (lowercase, numbers, hyphens)",
    profileColorOpt: "Profile color (hex format, e.g. #0066CC)",
    cdpUrlOpt: "CDP URL for remote Chrome (http/https)",
    driverOpt: "Profile driver (openclaw|extension). Default: openclaw",
    deleteProfileDescription: "Delete a browser profile",
    deleteProfileNameOpt: "Profile name to delete",
  },

  // src/cli/browser-cli-debug.ts
  browserDebugCli: {
    highlightDescription: "Highlight an element by ref",
    refArg: "Ref id from snapshot",
    errorsDescription: "Get recent page errors",
    clearOpt: "Clear stored errors after reading",
    requestsDescription: "Get recent network requests (best-effort)",
    filterOpt: "Only show URLs that contain this substring",
    traceDescription: "Record a Playwright trace",
    traceStartDescription: "Start trace recording",
    noScreenshotsOpt: "Disable screenshots",
    noSnapshotsOpt: "Disable snapshots",
    sourcesOpt: "Include sources (bigger traces)",
    traceStopDescription: "Stop trace recording and write a .zip",
    traceOutOpt: "Output path within openclaw temp dir (e.g. trace.zip or /tmp/openclaw/trace.zip)",
  },

  // src/cli/browser-cli-inspect.ts
  browserInspectCli: {
    screenshotDescription: "Capture a screenshot (MEDIA:<path>)",
    fullPageOpt: "Capture full scrollable page",
    refOpt: "ARIA ref from ai snapshot",
    elementOpt: "CSS selector for element screenshot",
    typeOpt: "Output type (default: png)",
    snapshotDescription: "Capture a snapshot (default: ai; aria is the accessibility tree)",
    formatOpt: "Snapshot format (default: ai)",
    limitOpt: "Max nodes (default: 500/800)",
    modeOpt: "Snapshot preset (efficient)",
    efficientOpt: "Use the efficient snapshot preset",
    interactiveOpt: "Role snapshot: interactive elements only",
    compactOpt: "Role snapshot: compact output",
    depthOpt: "Role snapshot: max depth",
    selectorOpt: "Role snapshot: scope to CSS selector",
    frameOpt: "Role snapshot: scope to an iframe selector",
    labelsOpt: "Include viewport label overlay screenshot",
    outOpt: "Write snapshot to a file",
  },

  // src/cli/browser-cli-state.ts
  browserStateCli: {
    setDescription: "Browser environment settings",
    viewportDescription: "Set viewport size (alias for resize)",
    viewportWidthArg: "Viewport width",
    viewportHeightArg: "Viewport height",
    offlineDescription: "Toggle offline mode",
    onOffArg: "on/off",
    headersDescription: "Set extra HTTP headers (JSON object)",
    headersJsonArg: "JSON object of headers (alternative to --headers-json)",
    headersJsonOpt: "JSON object of headers",
    credentialsDescription: "Set HTTP basic auth credentials",
    clearCredentialsOpt: "Clear credentials",
    usernameArg: "Username",
    passwordArg: "Password",
    geoDescription: "Set geolocation (and grant permission)",
    clearGeoOpt: "Clear geolocation + permissions",
    latitudeArg: "Latitude",
    longitudeArg: "Longitude",
    accuracyOpt: "Accuracy in meters",
    originOpt: "Origin to grant permissions for",
    mediaDescription: "Emulate prefers-color-scheme",
    darkLightNoneArg: "dark/light/none",
    timezoneDescription: "Override timezone (CDP)",
    timezoneIdArg: "Timezone ID (e.g. America/New_York)",
    localeDescription: "Override locale (CDP)",
    localeArg: "Locale (e.g. en-US)",
    deviceDescription: 'Apply a Playwright device descriptor (e.g. "iPhone 14")',
    deviceNameArg: "Device name (Playwright devices)",
  },

  // src/cli/browser-cli-state.cookies-storage.ts
  browserCookiesCli: {
    cookiesDescription: "Read/write cookies",
    setDescription: "Set a cookie (requires --url or domain+path)",
    nameArg: "Cookie name",
    valueArg: "Cookie value",
    urlOpt: "Cookie URL scope (recommended)",
    clearDescription: "Clear all cookies",
    storageDescription: "Read/write localStorage/sessionStorage",
    storageKindDescription: "{kind}Storage commands",
    storageGetDescription: "Get {kind}Storage (all keys or one key)",
    keyArg: "Key (optional)",
    storageSetDescription: "Set a {kind}Storage key",
    storageKeyArg: "Key",
    storageValueArg: "Value",
    storageClearDescription: "Clear all {kind}Storage keys",
  },

  // src/cli/browser-cli-actions-input/register.form-wait-eval.ts
  browserFormCli: {
    fillDescription: "Fill a form with JSON field descriptors",
    fieldsOpt: "JSON array of field objects",
    fieldsFileOpt: "Read JSON array from a file",
    waitDescription: "Wait for time, selector, URL, load state, or JS conditions",
    waitSelectorArg: "CSS selector to wait for (visible)",
    waitTimeOpt: "Wait for N milliseconds",
    waitTextOpt: "Wait for text to appear",
    waitTextGoneOpt: "Wait for text to disappear",
    waitUrlOpt: "Wait for URL (supports globs like **/dash)",
    waitLoadOpt: "Wait for load state",
    waitFnOpt: "Wait for JS condition (passed to waitForFunction)",
    waitTimeoutMsOpt: "How long to wait for each condition (default: 20000)",
    evaluateDescription: "Evaluate a function against the page or a ref",
    evaluateFnOpt: "Function source, e.g. (el) => el.textContent",
    evaluateRefOpt: "Ref from snapshot",
  },

  // src/cli/browser-cli-actions-input/register.element.ts
  browserElementCli: {
    clickDescription: "Click an element by ref from snapshot",
    refArg: "Ref id from snapshot",
    doubleOpt: "Double click",
    buttonOpt: "Mouse button to use",
    modifiersOpt: "Comma-separated modifiers (Shift,Alt,Meta)",
    typeDescription: "Type into an element by ref from snapshot",
    textArg: "Text to type",
    submitOpt: "Press Enter after typing",
    slowlyOpt: "Type slowly (human-like)",
    pressDescription: "Press a key",
    keyArg: "Key to press (e.g. Enter)",
    hoverDescription: "Hover an element by ai ref",
    scrollIntoViewDescription: "Scroll an element into view by ref from snapshot",
    timeoutMsOpt: "How long to wait for scroll (default: 20000)",
    dragDescription: "Drag from one ref to another",
    startRefArg: "Start ref id",
    endRefArg: "End ref id",
    selectDescription: "Select option(s) in a select element",
    valuesArg: "Option values to select",
  },

  // src/cli/webhooks-cli.ts
  webhooksCli: {
    description: "Webhook helpers and integrations",
    gmailDescription: "Gmail Pub/Sub hooks (via gogcli)",
    setupDescription: "Configure Gmail watch + Pub/Sub + OpenClaw hooks",
    accountOpt: "Gmail account to watch",
    projectOpt: "GCP project id (OAuth client owner)",
    topicOpt: "Pub/Sub topic name",
    subscriptionOpt: "Pub/Sub subscription name",
    labelOpt: "Gmail label to watch",
    hookUrlOpt: "OpenClaw hook URL",
    hookTokenOpt: "OpenClaw hook token",
    pushTokenOpt: "Push token for gog watch serve",
    bindOpt: "gog watch serve bind host",
    portOpt: "gog watch serve port",
    pathOpt: "gog watch serve path",
    includeBodyOpt: "Include email body snippets",
    maxBytesOpt: "Max bytes for body snippets",
    renewMinutesOpt: "Renew watch every N minutes",
    tailscaleOpt: "Expose push endpoint via tailscale (funnel|serve|off)",
    tailscalePathOpt: "Path for tailscale serve/funnel",
    tailscaleTargetOpt: "Tailscale serve/funnel target (port, host:port, or URL)",
    pushEndpointOpt: "Explicit Pub/Sub push endpoint",
    jsonOpt: "Output JSON summary",
    runDescription: "Run gog watch serve + auto-renew loop",
    runAccountOpt: "Gmail account to watch",
    runTopicOpt: "Pub/Sub topic path (projects/.../topics/..)",
    runSubscriptionOpt: "Pub/Sub subscription name",
    runLabelOpt: "Gmail label to watch",
    runHookUrlOpt: "OpenClaw hook URL",
    runHookTokenOpt: "OpenClaw hook token",
    runPushTokenOpt: "Push token for gog watch serve",
    runBindOpt: "gog watch serve bind host",
    runPortOpt: "gog watch serve port",
    runPathOpt: "gog watch serve path",
    runIncludeBodyOpt: "Include email body snippets",
    runMaxBytesOpt: "Max bytes for body snippets",
    runRenewMinutesOpt: "Renew watch every N minutes",
    runTailscaleOpt: "Expose push endpoint via tailscale (funnel|serve|off)",
    runTailscalePathOpt: "Path for tailscale serve/funnel",
    runTailscaleTargetOpt: "Tailscale serve/funnel target (port, host:port, or URL)",
  },

  // src/cli/gateway-cli/register.ts
  gatewayCli: {
    description: "Run, inspect, and query the WebSocket Gateway",
    runDescription: "Run the WebSocket Gateway (foreground)",
    statusDescription: "Show gateway service status + probe the Gateway",
    callDescription: "Call a Gateway method",
    callMethodArg: "Method name (health/status/system-presence/cron.*)",
    callParamsOpt: "JSON object string for params",
    usageCostDescription: "Fetch usage cost summary from session logs",
    usageCostDaysOpt: "Number of days to include",
    healthDescription: "Fetch Gateway health",
    probeDescription:
      "Show gateway reachability + discovery + health + status summary (local + remote)",
    probeUrlOpt: "Explicit Gateway WebSocket URL (still probes localhost)",
    probeSshOpt: "SSH target for remote gateway tunnel (user@host or user@host:port)",
    probeSshIdentityOpt: "SSH identity file path",
    probeSshAutoOpt: "Try to derive an SSH target from Bonjour discovery",
    probeTokenOpt: "Gateway token (applies to all probes)",
    probePasswordOpt: "Gateway password (applies to all probes)",
    probeTimeoutOpt: "Overall probe budget in ms",
    probeJsonOpt: "Output JSON",
    discoverDescription: "Discover gateways via Bonjour (local + wide-area if configured)",
    discoverTimeoutOpt: "Per-command timeout in ms",
    discoverJsonOpt: "Output JSON",
  },
  ...
  daemonCli: {
    ...
    statusDescription: "Show gateway service status + probe the Gateway",
    statusUrlOpt: "Gateway WebSocket URL (defaults to config/remote/local)",
    statusTokenOpt: "Gateway token (if required)",
    statusPasswordOpt: "Gateway password (password auth)",
    statusTimeoutOpt: "Timeout in ms",
    statusNoProbeOpt: "Skip RPC probe",
    statusDeepOpt: "Scan system-level services",
    jsonOpt: "Output JSON",
    installDescription: "Install the Gateway service (launchd/systemd/schtasks)",
    installPortOpt: "Gateway port",
    installRuntimeOpt: "Daemon runtime (node|bun). Default: node",
    installTokenOpt: "Gateway token (token auth)",
    installForceOpt: "Reinstall/overwrite if already installed",
    uninstallDescription: "Uninstall the Gateway service (launchd/systemd/schtasks)",
    startDescription: "Start the Gateway service (launchd/systemd/schtasks)",
    stopDescription: "Stop the Gateway service (launchd/systemd/schtasks)",
    restartDescription: "Restart the Gateway service (launchd/systemd/schtasks)",
  },

  // src/cli/node-cli/register.ts
  nodeCli: {
    description: "Run and manage the headless node host service",
    runDescription: "Run the headless node host (foreground)",
    runHostOpt: "Gateway host",
    runPortOpt: "Gateway port",
    runTlsOpt: "Use TLS for the gateway connection",
    runTlsFingerprintOpt: "Expected TLS certificate fingerprint (sha256)",
    runNodeIdOpt: "Override node id (clears pairing token)",
    runDisplayNameOpt: "Override node display name",
    statusDescription: "Show node host status",
    jsonOpt: "Output JSON",
    installDescription: "Install the node host service (launchd/systemd/schtasks)",
    installRuntimeOpt: "Service runtime (node|bun). Default: node",
    installForceOpt: "Reinstall/overwrite if already installed",
    uninstallDescription: "Uninstall the node host service (launchd/systemd/schtasks)",
    stopDescription: "Stop the node host service (launchd/systemd/schtasks)",
    restartDescription: "Restart the node host service (launchd/systemd/schtasks)",
  },

  // src/cli/secrets-cli.ts (CLI description/option keys added to existing secretsCli)
  // Note: secretsCli runtime keys (applyPlanNow, migrationOneWay, etc.) are in the main en object

  // src/cli/models-cli.ts (modelArg, aliasArg added to main cli.models; auth.agentOpt and auth.order.set.profileIdsArg added inline)
  ...
  nodesStatusCli: {
    statusDescription: "List known nodes with connection status and capabilities",
    connectedOpt: "Only show connected nodes",
    lastConnectedOpt: "Only show nodes connected within duration (e.g. 24h)",
    describeDescription: "Describe a node (capabilities + supported invoke commands)",
    nodeOpt: "Node id, name, or IP",
    listDescription: "List pending and paired nodes",
  },

  // src/cli/nodes-cli/register.pairing.ts
  nodesPairingCli: {
    pendingDescription: "List pending pairing requests",
    approveDescription: "Approve a pending pairing request",
    requestIdArg: "Pending request id",
    rejectDescription: "Reject a pending pairing request",
    renameDescription: "Rename a paired node (display name override)",
    newNameOpt: "New display name",
  },

  // src/cli/nodes-cli/register.invoke.ts
  nodesInvokeCli: {
    invokeDescription: "Invoke a command on a paired node",
    commandOpt: "Command (e.g. canvas.eval)",
    paramsOpt: "JSON object string for params",
    invokeTimeoutOpt: "Node invoke timeout in ms (default 15000)",
    idempotencyKeyOpt: "Idempotency key (optional)",
    runDescription: "Run a shell command on a node (mac only)",
    cwdOpt: "Working directory",
    envOpt: "Environment override (repeatable)",
    rawOpt: "Run a raw shell command string (sh -lc / cmd.exe /c)",
    agentOpt: "Agent id (default: configured default agent)",
    askOpt: "Exec ask mode (off|on-miss|always)",
    securityOpt: "Exec security mode (deny|allowlist|full)",
    commandTimeoutOpt: "Command timeout (ms)",
    needsScreenRecordingOpt: "Require screen recording permission",
    runInvokeTimeoutOpt: "Node invoke timeout in ms (default 30000)",
    commandArg: "Command and args",
  },

  // src/cli/nodes-cli/register.notify.ts
  nodesNotifyCli: {
    description: "Send a local notification on a node (mac only)",
    titleOpt: "Notification title",
    bodyOpt: "Notification body",
    soundOpt: "Notification sound",
    priorityOpt: "Notification priority",
    deliveryOpt: "Delivery mode",
  },
  ...
  nodesPushCli: {
    ...
    titleOpt: "Push title",
    bodyOpt: "Push body",
    environmentOpt: "Override APNs environment",
  },

  // src/cli/nodes-cli/register.canvas.ts
  nodesCanvasCli: {
    description: "Capture or render canvas content from a paired node",
    snapshotDescription: "Capture a canvas snapshot (prints MEDIA:<path>)",
    formatOpt: "Image format",
    maxWidthOpt: "Max width in px (optional)",
    qualityOpt: "JPEG quality (optional)",
    invokeTimeoutOpt20s: "Node invoke timeout in ms (default 20000)",
    presentDescription: "Show the canvas (optionally with a target URL/path)",
    targetOpt: "Target URL/path (optional)",
    xOpt: "Placement x coordinate",
    yOpt: "Placement y coordinate",
    widthOpt: "Placement width",
    heightOpt: "Placement height",
    invokeTimeoutOpt: "Node invoke timeout in ms",
    hideDescription: "Hide the canvas",
    navigateDescription: "Navigate the canvas to a URL",
    urlArg: "Target URL/path",
    evalDescription: "Evaluate JavaScript in the canvas",
    jsArg: "JavaScript to evaluate",
    jsOpt: "JavaScript to evaluate",
    a2uiDescription: "Render A2UI content on the canvas",
    a2uiPushDescription: "Push A2UI JSONL to the canvas",
    jsonlOpt: "Path to JSONL payload",
    textOpt: "Render a quick A2UI text payload",
    a2uiResetDescription: "Reset A2UI renderer state",
  },

  // src/cli/nodes-cli/register.camera.ts
  nodesCameraCli: {
    description: "Capture camera media from a paired node",
    listDescription: "List available cameras on a node",
    snapDescription: "Capture a photo from a node camera (prints MEDIA:<path>)",
    facingOpt: "Camera facing",
    deviceIdOpt: "Camera device id (from nodes camera list)",
    qualityOpt: "JPEG quality (default 0.9)",
    delayMsOpt: "Delay before capture in ms (macOS default 2000)",
    clipDescription: "Capture a short video clip from a node camera (prints MEDIA:<path>)",
    durationOpt: "Duration (default 3000ms; supports ms/s/m, e.g. 10s)",
    noAudioOpt: "Disable audio capture",
    invokeTimeout90sOpt: "Node invoke timeout in ms (default 90000)",
  },

  // src/cli/nodes-cli/register.screen.ts
  nodesScreenCli: {
    description: "Capture screen recordings from a paired node",
    recordDescription: "Capture a short screen recording from a node (prints MEDIA:<path>)",
    screenIndexOpt: "Screen index (0 = primary)",
    durationOpt: "Clip duration (ms or 10s)",
    fpsOpt: "Frames per second",
    noAudioOpt: "Disable microphone audio capture",
    outOpt: "Output path",
    invokeTimeoutOpt: "Node invoke timeout in ms (default 120000)",
  },

  // src/cli/nodes-cli/register.location.ts
  nodesLocationCli: {
    description: "Fetch location from a paired node",
    getDescription: "Fetch the current location from a node",
    maxAgeOpt: "Use cached location newer than this (ms)",
    accuracyOpt: "Desired accuracy (default: balanced/precise depending on node setting)",
    locationTimeoutOpt: "Location fix timeout (ms)",
  },

  // src/cli/cron-cli/register.ts + register.cron-add.ts
  cronCli: {
    description: "Manage cron jobs (via Gateway)",
    statusDescription: "Show cron scheduler status",
    jsonOpt: "Output JSON",
    listDescription: "List cron jobs",
    listAllOpt: "Include disabled jobs",
    addDescription: "Add a cron job",
    addNameOpt: "Job name",
    addDescriptionOpt: "Optional description",
    addDisabledOpt: "Create job disabled",
    addDeleteAfterRunOpt: "Delete one-shot job after it succeeds",
    addKeepAfterRunOpt: "Keep one-shot job after it succeeds",
    addAgentOpt: "Agent id for this job",
    addSessionOpt: "Session target (main|isolated)",
    addSessionKeyOpt: "Session key for job routing (e.g. agent:my-agent:my-session)",
    addWakeOpt: "Wake mode (now|next-heartbeat)",
    addAtOpt: "Run once at time (ISO) or +duration (e.g. 20m)",
    addEveryOpt: "Run every duration (e.g. 10m, 1h)",
    addCronOpt: "Cron expression (5-field or 6-field with seconds)",
    addTzOpt: "Timezone for cron expressions (IANA)",
    addStaggerOpt: "Cron stagger window (e.g. 30s, 5m)",
    addExactOpt: "Disable cron staggering (set stagger to 0)",
    addSystemEventOpt: "System event payload (main session)",
    addMessageOpt: "Agent message payload",
    addThinkingOpt: "Thinking level for agent jobs (off|minimal|low|medium|high)",
    addModelOpt: "Model override for agent jobs (provider/model or alias)",
    addTimeoutSecondsOpt: "Timeout seconds for agent jobs",
    addLightContextOpt: "Use lightweight bootstrap context for agent jobs",
    addAnnounceOpt: "Announce summary to a chat (subagent-style)",
    addDeliverOpt: "Deprecated (use --announce). Announces a summary to a chat.",
    addNoDeliverOpt: "Disable announce delivery and skip main-session summary",
    addToOpt: "Delivery destination (E.164, Telegram chatId, or Discord channel/user)",
    addAccountOpt: "Channel account id for delivery (multi-account setups)",
    addBestEffortDeliverOpt: "Do not fail the job if delivery fails",
    jobIdArg: "Job id",
  },
  ...
  cronEditCli: {
    ...
    idArg: "Job id",
    nameOpt: "Set name",
    descriptionOpt: "Set description",
    enableOpt: "Enable job",
    disableOpt: "Disable job",
    agentOpt: "Set agent id",
    clearAgentOpt: "Unset agent and use default",
    sessionKeyOpt: "Set session key for job routing",
    clearSessionKeyOpt: "Unset session key",
    atOpt: "Set one-shot time (ISO) or duration like 20m",
    everyOpt: "Set interval duration like 10m",
    cronOpt: "Set cron expression",
    systemEventOpt: "Set systemEvent payload",
    messageOpt: "Set agentTurn payload message",
    thinkingOpt: "Thinking level for agent jobs",
    modelOpt: "Model override for agent jobs",
    lightContextOpt: "Enable lightweight bootstrap context for agent jobs",
    noLightContextOpt: "Disable lightweight bootstrap context for agent jobs",
    noDeliverOpt: "Disable announce delivery",
    bestEffortDeliverOpt: "Do not fail job if delivery fails",
    noBestEffortDeliverOpt: "Fail job when delivery fails",
    failureAlertOpt: "Enable failure alerts for this job",
    noFailureAlertOpt: "Disable failure alerts for this job",
    failureAlertAfterOpt: "Alert after N consecutive job errors",
    failureAlertToOpt: "Failure alert destination",
    failureAlertCooldownOpt: "Minimum time between alerts (e.g. 1h, 30m)",
    failureAlertModeOpt: "Failure alert delivery mode (announce or webhook)",
    failureAlertAccountIdOpt: "Account ID for failure alert channel (multi-account setups)",
  },

  // src/cli/cron-cli/register.cron-simple.ts
  cronSimpleCli: {
    rmDescription: "Remove a cron job",
    enableDescription: "Enable a cron job",
    disableDescription: "Disable a cron job",
    runsDescription: "Show cron run history (JSONL-backed)",
    runsLimitOpt: "Max entries (default 50)",
    runDescription: "Run a cron job now (debug)",
    runDueOpt: "Run only when due (default behavior in older versions)",
  },
});
