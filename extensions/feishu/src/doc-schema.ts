...
const tableCreationProperties = {
  ...
  parent_block_id: Type.Optional(
    Type.String({ description: "父块 ID（默认：文档根节点）" }),
  ),
  row_size: Type.Integer({ description: "表格行数", minimum: 1 }),
  column_size: Type.Integer({ description: "表格列数", minimum: 1 }),
...
export const FeishuDocSchema = Type.Union([
  ...
  Type.Object({
    ...
    doc_token: Type.String({ description: "文档令牌" }),
    content: Type.String({ description: "追加到文档末尾的 Markdown 内容" }),
  }),
  Type.Object({
